          ...
          <CardFooter className="flex justify-between items-center gap-4">
            <Button
              onClick={async () => {
                ...
                try {
                  const residentFullName = editedResidentName || (
                    ...
                    <>
                      ...
                      >
                        ...
                        <Text style={{ fontWeight: "bold" }}>
                          {(editedResidentName || `${selectedResident.Firstname}${selectedResident.Middlename ? " " + selectedResident.Middlename.charAt(0) + "." : ""} ${selectedResident.Lastname}${selectedResident.Suffix ? " " + selectedResident.Suffix : ""}`.replace(/\s+/g, " ").trim()).toUpperCase()}
                        </Text>
                        <Text>
